...
module.exports = async function handler(req, res) {
  ...
  const { email, orgName, role, invitedBy } = req.body
...
<body style="margin:0;padding:0;background:#f8fafc;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:560px;margin:40px auto;background:#fff;border-radius:12px;border:1px solid #e2e8f0;overflow:hidden;">
    ...
    <div style="padding:32px;">
      ...
      <a href="${appUrl}/signup" style="display:inline-block;background:#1a6bff;color:#fff;font-size:14px;font-weight:700;padding:13px 28px;border-radius:8px;text-decoration:none;">
        Accept invitation →
      </a>
